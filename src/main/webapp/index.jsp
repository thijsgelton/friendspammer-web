...
<p>Hier kan je email naar al je vrienden! Bij aan kan je één enkele emailadres opgeven maar je kan er ook een comma
    seperated lijst opgeven.</p>

<form method="post">
    onderwerp: <input type="text" name="onderwerp"/><br/>
    aan: <input type="text" name="aan" value="5b0abc0c54-a39515@inbox.mailtrap.io" size="100"/><br/>
    bericht: <textarea name="tekst" rows="5" cols="60"></textarea><br/>
    verstuur als html?: <input type="checkbox" name="html" value="true"/> <br/>
    email <input type="radio" name="methode" value="email" checked="checked"/> of sms <input type="radio" name="methode"
                                                                                             value="sms" disabled/>
    (sorry sms werkt nog niet)
    <br/>
    <input value="spammen maar!" type="submit">
</form>

<p><a href="history.jsp">history</a>
<p>
